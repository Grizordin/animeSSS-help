...
const functions=['parseStat','getRareFactor','stretchToOne','calcCardValue','calcTradeSValue','calcBadCardValue','getCardRank','isGoldSCard','getCardId','computeCardValue','getActiveRow','addCardValue','highlightBestCard','getBestCardDefaults','getBestCardSettingGroups','normalizeBestCardSettings','getBestCardPolicy','isBestCardRare','getBestCardPriorityValue','selectBestCardEntries','syncBestCardHighlights','syncBestCardReasons','cleanupBestCardSettingsUi','addNeonToCard','clearNeonFromCard','getNeonCardType','applyNeonToCard','getPackTools','insertStatsButton','placePackStatsButton','cleanupStatsUi','insertGuaranteeInfo','autoPackReady','autoBeginChoice','autoCheckChoice','autoClickBestCard','handleAutoManualPick','suiteTelemetryFlush'].map(extract).join('\n');

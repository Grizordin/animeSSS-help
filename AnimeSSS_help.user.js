...
(function () {
  ...
  const CPT_MAP = [
    ...
    {s:'Вы уже поставили 3 лайка на карты, которые сейчас на модерации. Дождитесь следующей партии карт и сможете ставить новые', icon:'clock', title:'Лимит', theme:'rose'},
    ...
    {s:'Данная карта не доступна к повышению уровня звёздности, но модераторы получили вашу заявку и после рассмотрения вы сможете улучшать данную карту', icon:'star', title:'Улучшение', theme:'neon-amber'},
    ...
    {r:/Получение награды с бесконечной гачи отключено с \d{1,2}:\d{2} до \d{1,2}:\d{2}/i, icon:'clock', title:'Обслуживание', theme:'neon-amber'},
    {s:'Духовная энергия получена',                               icon:'bolt',   title:'Энергия',     theme:'neon-blue' },
    {s:'Духовный телепорт перенёс твоё астральное тело во владения другого игрока. Сначала заплати дань или захвати комнату более сильным SSS-стражем.', icon:'shield', title:'Телепорт', theme:'neon-amber'},
    ...
    {s:'Карта пока не доступна к пробуждению, модераторы уже получили вашу заявку на разблокировку пробуждения карты, дождитесь уведомления', icon:'lock', title:'Пробуждение', theme:'neon-amber'},
